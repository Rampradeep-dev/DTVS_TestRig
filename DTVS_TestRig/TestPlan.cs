...
namespace DTVS_TestRig
{
    public class TestPlan
    {
        ...
        public string Tolerance_bar { get; set; }
        ...
        public string BL_Flow_OffSet { get; set; }
        public string IL_Flow_Min { get; set; }
        public string IL_Flow_Max { get; set; }
        public string IL_Flow_OffSet { get; set; }
        public string VentPres_Min { get; set; }
        public string VenPres_Max { get; set; }
